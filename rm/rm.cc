...
RC RelationManager::createCatalog()
{
    ...
    for(int i=0;i<attrs.size();i++){
        ...
        int nullAttributesIndicatorActualSize1 = ceil((double) 5/ CHAR_BIT);
...
void RelationManager::prepareTuple_cols(int attributeCount, unsigned char *nullAttributesIndicator, const int Table_ID, const int lengthOffield, const string &fieldName, const int fieldOfType, const int max_length, const int field_ID, void *buffer, int *tupleSize)
{
    int offset = 0;
