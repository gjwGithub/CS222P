...
public:
  ...
  RC appendDataInPage(FileHandle &fileHandle, int pageNum, const void *data, int slotSize, RID &rid);
  RC addDataInNewPage(FileHandle &fileHandle, const void *data, int dataSize, RID &rid);
